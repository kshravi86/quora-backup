    ...
    def backup(self, format, mongodb_uri=None, path=None, type=None):
        ...
        if format == 'json':
            if type == 'answers':
                ...
                json_backup(self.activity.want_answers, os.path.join(path, 'questions.json'))
            elif type == 'upvotes':
            ...
            if type == 'answers':
                ...
                csv_backup(self.activity.want_answers, os.path.join(path, 'questions.csv'))
            elif type == 'upvotes':
            ...
            if type == 'answers':
                ...
                mongodb_backup(self.activity.want_answers, collection, self.user, 'question')
            elif type == 'upvotes':
